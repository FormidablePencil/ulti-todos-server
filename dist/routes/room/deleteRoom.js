...
const deleteRoom = express_1.default.Router();
deleteRoom.delete('/', authUser_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { _id, userAccessId } = req.body;
    try {
        yield room_1.default.deleteOne({ _id, users: userAccessId });
